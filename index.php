...
<?php
 ...
 foreach($filas as $value){
  ...
  $BDAlmacen = array( 
    array(1, 2, 3, 4, 5, 6), //El IDProducto
    array(0,10, 5,15, 3, 4)); //Las Existencias
...
<head>
    ...
    <meta name="Jesus Andres" content="">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="agregarproductos.php" target="_blank" checkout.php><i class="fa fa-crosshairs"></i> Pagar</a></li>
